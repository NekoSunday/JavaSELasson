...
//        System.out.println(workerList.get(indexChange).toString());
    ...
    static void printPersonalIdentity(String str) throws Exception {
        MainSystem.ps = MainSystem.system.prepareStatement("select * from employee_identity where ename=?");
        MainSystem.ps.setString(1,str);
        System.out.println(MainSystem.ps.executeQuery().next());
