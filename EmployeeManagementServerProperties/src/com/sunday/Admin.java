...
public class Admin {
    ...
    static File admin=new File("D:\\JavaSE\\EmployeeManagementServerProperties\\adminInfo.properties");
    ...
    static {
        try {
            ...
            util.adminBw=new BufferedWriter(new OutputStreamWriter(new FileOutputStream(admin)));
            prop.load(new InputStreamReader(new FileInputStream(admin)));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void registerAdmin() throws Exception {
        ...
        util.adminBw.write(String.valueOf(adminInfo));
        prop.setProperty(String.valueOf(id++),String.valueOf(adminInfo));
        prop.store(new OutputStreamWriter(new FileOutputStream(admin)),"");
